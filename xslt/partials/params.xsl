...
<xsl:stylesheet 
    ...
    <xsl:param name="directory_name">tillich-briefe-1-static</xsl:param>
    ...
    <xsl:param name="github_url">https://github.com/TillichCorrespondence/tillich-briefe-1-static</xsl:param>
