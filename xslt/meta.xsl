        ...
        <xsl:if test="descendant::tei:div[starts-with(@type, 'level')]">
            <!--             <xsl:element name="nav">
                ...
                <div class="container">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#verticalNavbar" aria-controls="verticalNavbar" aria-expanded="false" aria-label="Toggle navigation">
