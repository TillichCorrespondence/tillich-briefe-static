...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
                                        ...
                                        <xsl:for-each select="descendant::tei:place">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <xsl:choose>
                                                        <xsl:when test="descendant::tei:location/tei:geo[1]">
                                                            <xsl:variable name="lat" select="replace(tokenize(descendant::tei:geo[1]/text(), ' ')[1], ',', '.')" as="xs:string"/>
                                                ...
                                                <td>
                                                    <xsl:choose>
                                                        <xsl:when test="descendant::tei:location/tei:geo[1]">
                                                            <xsl:variable name="long" select="replace(tokenize(descendant::tei:geo[1]/text(), ' ')[2], ',', '.')" as="xs:string"/>
    ...
    <xsl:function name="foo:grad-kuerzen">
        ...
        <xsl:variable name="vordempunkt" as="xs:string" select="substring-before($eingangs-grad, '.')"/>
        <xsl:variable name="nachdempunkt" as="xs:string" select="substring-after($eingangs-grad, '.')"/>
        <xsl:choose>
